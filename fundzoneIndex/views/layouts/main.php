			...
			<header class="header fixed">
				<div class="top">
					<div class="maxW">
							...
							<span class="inline fR userLink">
								...
								<div class="loginS">
									<ul>
										...
										<li><a href="<?= Yii::$app->params['tradeHost']?>company/login/" class="actLink">企业账户</a></li>
									</ul>
								</div>
							</span>
						</div>
						...
						<div class="userInfo">
							<span class="inline fR">
								<a href="<?= Yii::$app->params['tradeHost']?>user/loginout/" class="openAccount outLink">退出</a>
							</span>
							<span class="inline fR userLink">
								<a href="javascript:void(0);" class="login user">我</a>
								<div class="loginS">
									<ul>
										<li><a href="<?= Yii::$app->params['tradeHost'];?>position/assets/" class="actLink">我的资产</a></li>
										<li><a href="<?= Yii::$app->params['tradeHost'];?>record/list/" class="actLink">交易记录</a></li>
										<li><a href="<?= Yii::$app->params['tradeHost'];?>user/changepassword/" class="actLink">修改密码</a></li>
									</ul>
								</div>
							</span>
						</div>
				...
				<div class="maxW">
					<h1><a href="<?= Url::home();?>" class="logo">汇成基金<!--<img src="<?= Url::base();?>/images/logo.png" width="100%"/>--></a></h1>
					<nav class="nav">
						<a href="<?= Url::base();?>/site/index" class="navLink <?= Yii::$app->controller->action->id == 'index' ? 'cur' : ''; ?>">首页</a>
						<a href="<?= Url::base();?>/site/product" class="navLink <?= in_array(Yii::$app->controller->action->id, $productMenu) ? 'cur' : ''; ?>">基金产品</a>
						<a href="<?= Url::base();?>/site/news" class="navLink <?= in_array(Yii::$app->controller->action->id, $newsMenu) ? 'cur' : ''; ?>">信息资讯</a>
						<a href="<?= Url::base();?>/site/open-account" class="navLink <?= in_array(Yii::$app->controller->action->id, $openAccount) ? 'cur' : ''; ?>">企业理财</a>
						<a href="<?= Url::base();?>/site/call-center" class="navLink <?= in_array(Yii::$app->controller->action->id, $callCenter) ? 'cur' : ''; ?>">客服中心</a>
						<a href="<?= Url::base();?>/site/about" class="navLink <?= in_array(Yii::$app->controller->action->id, $about) ? 'cur' : ''; ?>">关于我们</a>
					</nav>
				</div>
			</header>
			...
			<div class="footerNav fixed">
				<ul>
					<li>
						...
						<a class="fNavLink" href="<?= Url::base();?>/site/about">公司介绍</a>
						<a class="fNavLink" href="<?= Url::base();?>/site/culture">企业文化</a>
						<a class="fNavLink" href="<?= Url::base();?>/site/practitioners">基金从业信息</a>
						<a class="fNavLink" href="<?= Url::base();?>/site/aptitude">资质证明</a>
						<a class="fNavLink" href="<?= Url::base();?>/site/contact">联系方式</a>
						<a class="fNavLink" href="<?= Url::base();?>/site/recruit">诚聘英才</a>
					</li>
					<li>
						<span class="fNavTitle">帮助中心</span>
						<a class="fNavLink" href="<?= Url::base();?>/site/call-center">开户指南</a>
						<a class="fNavLink" href="<?= Url::base();?>/site/trade-guide">交易指南</a>
						<a class="fNavLink" href="<?= Url::base();?>/site/trade-quota">交易限额</a>
						<a class="fNavLink" href="<?= Url::base();?>/site/basis">基础知识</a>
					</li>
					<li style="width: auto;">
						<span class="fNavTitle">投资者权益</span>
						<a class="fNavLink" href="<?= Url::base();?>/site/investor">投资者权益</a>
						<a class="fNavLink" href="<?= Url::base();?>/site/risk-warning">风险提示</a>
						<a class="fNavLink" href="<?= Url::base();?>/site/anti-money-laundering">反洗钱</a>
						<a class="fNavLink" href="<?= Url::base();?>/site/feedback">问题反馈</a>
					</li>
					<li class="snsWarp">
