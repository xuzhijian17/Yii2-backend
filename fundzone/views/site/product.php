...
function viewList(data){
	...
	$.each(data, function(i, data){
		...
		html += '<td></td>';
		html += '<td class="talL"><a class="colblue" href="<?= Url::to(['site/detail']);?>?fundcode='+data['FundCode']+'"><span class="fundTag '+fundtype+'">'+data['FundName']+'<br />'+data['FundCode']+'</span></a></td>'
		...
		html += '<td><a href="/trade/purchase-page?fundcode='+data['FundCode']+'" class="buttonB">购买</a></td></tr>';
	});
